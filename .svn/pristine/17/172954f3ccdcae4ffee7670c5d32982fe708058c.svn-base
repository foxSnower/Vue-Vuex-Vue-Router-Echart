...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      INSURANCE_XINBAOTAI_AREA_LITTLE: state => state.INSURANCE_XINBAOTAI_AREA_LITTLE,
      INSURANCE_XINBAOJIN_AREA_LITTLE: state => state.INSURANCE_XINBAOJIN_AREA_LITTLE,
      INSURANCE_XUBAOTAI_AREA_LITTLE: state => state.INSURANCE_XUBAOTAI_AREA_LITTLE,
      INSURANCE_XUBAOJIN_AREA_LITTLE: state => state.INSURANCE_XUBAOJIN_AREA_LITTLE,
