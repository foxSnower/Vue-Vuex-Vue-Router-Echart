...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      SERVICE_YINGSHOU_AREA_LITTLE: state => state.SERVICE_YINGSHOU_AREA_LITTLE,
      SERVICE_HUICHANTAI_AREA_LITTLE: state => state.SERVICE_HUICHANTAI_AREA_LITTLE,
      SERVICE_GONGDANSHU_AREA_LITTLE: state => state.SERVICE_GONGDANSHU_AREA_LITTLE,
      SERVICE_BEIJIANDINGJIN_AREA_LITTLE: state => state.SERVICE_BEIJIANDINGJIN_AREA_LITTLE,
      SERVICE_BAOYOUKEHU_AREA_LITTLE: state => state.SERVICE_BAOYOUKEHU_AREA_LITTLE,
      SERVICE_BEIJIANKUJIN_AREA_LITTLE: state => state.SERVICE_BEIJIANKUJIN_AREA_LITTLE,
