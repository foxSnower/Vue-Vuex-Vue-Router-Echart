...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      INSURANCE_XINBAOTAI_AREA: state => state.INSURANCE_XINBAOTAI_AREA,
      INSURANCE_XINBAOJIN_AREA: state => state.INSURANCE_XINBAOJIN_AREA,
      INSURANCE_XUBAOTAI_AREA: state => state.INSURANCE_XUBAOTAI_AREA,
      INSURANCE_XUBAOJIN_AREA: state => state.INSURANCE_XUBAOJIN_AREA,
