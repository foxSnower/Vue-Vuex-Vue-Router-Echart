...
export default {
  ...
  methods: {
    ...
    initParmes(tab, stockDateSelect, myBrandSelect, myCarSelect) {
      ...
      if (tab == 1) { //1按组织 2按品牌 3按车系
        ...
        parmes.orgType = '4'; //====================1 集团 2大区 3 小区 4 4s店
  ...
  computed: {
    ...
    ...mapState({
      ...
      STOCK_ZAIKU_AREA_TINY: state => state.STOCK_ZAIKU_AREA_TINY,
      STOCK_ZAITU_AREA_TINY: state => state.STOCK_ZAITU_AREA_TINY,
      STOCK_KEGONGXIAO_AREA_TINY: state => state.STOCK_KEGONGXIAO_AREA_TINY,
      STOCK_ZAIKUJIN_AREA_TINY: state => state.STOCK_ZAIKUJIN_AREA_TINY,
