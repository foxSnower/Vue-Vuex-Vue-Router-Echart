...
export default {
  ...
  computed: {
    ...
    ...mapState({
     ...
     SERVICE_YINGSHOU_AREA_TINY: state => state.SERVICE_YINGSHOU_AREA_TINY,
      SERVICE_HUICHANTAI_AREA_TINY: state => state.SERVICE_HUICHANTAI_AREA_TINY,
      SERVICE_GONGDANSHU_AREA_TINY: state => state.SERVICE_GONGDANSHU_AREA_TINY,
      SERVICE_BEIJIANDINGJIN_AREA_TINY: state => state.SERVICE_BEIJIANDINGJIN_AREA_TINY,
      SERVICE_BAOYOUKEHU_AREA_TINY: state => state.SERVICE_BAOYOUKEHU_AREA_TINY,
      SERVICE_BEIJIANKUJIN_AREA_TINY: state => state.SERVICE_BEIJIANKUJIN_AREA_TINY,
